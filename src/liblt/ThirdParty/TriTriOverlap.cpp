...
bool CoplanarTriTri(
  const V3& n, const V3& v0, const V3& v1, const V3& v2,
...
#ifdef OPC_TRITRI_EPSILON_TEST
  if (Abs(dv0) < LOCAL_EPSILON) dv0 = 0.0f;
  if (Abs(dv1) < LOCAL_EPSILON) dv1 = 0.0f;
  if (Abs(dv2) < LOCAL_EPSILON) dv2 = 0.0f;
#endif
